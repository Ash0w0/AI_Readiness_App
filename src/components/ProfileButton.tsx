    ...
    >
      ...
      >
        <div className="flex items-center gap-2 p-3 rounded-full backdrop-blur-lg bg-white/10 border border-white/20 hover:bg-white/20 transition-colors">
          {/* User Initials */}
          <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-sm profile-glow">
              ...
              <GlassCard className="p-6">
                ...
                <div className="pt-4 border-t border-white/10">
                  <AnimatedButton
                    ...
                    className="w-full flex items-center justify-center gap-2 text-red-400 hover:bg-red-500/10"
                    glowing={false}
                  >
